...
the interface named Framework02Intfc.  That 
...
class Framework02 extends Frame{
  Image rawImg;
  ...
  // class definition for this program is included 
  ...
  Framework02Intfc imageProcessingObject;
  //-------------------------------------------//
  ...
  public static void main(String[] args){
    ...
    Framework02 obj = new Framework02();
  }//end main
  //-------------------------------------------//

  public Framework02(){//constructor
    ...
    try{
      imageProcessingObject = (
               Framework02Intfc)Class.forName(
